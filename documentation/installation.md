...
1) il faut se placer dans src.main.java.nate.company.java.angular.angularclient
...
peut-être à recréer le fichier angular/src.main.java.nate.company.java.angular.angularclient/angular.json :
...
```
{
  ...
  "projects": {
    "src.main.java.nate.company.java.angular.angularclient": {
      ...
      "architect": {
        "build": {
          ...
          "options": {
            "outputPath": "dist/src.main.java.nate.company.java.angular.angularclient",
        ...
        "serve": {
          ...
          "configurations": {
            "production": {
              "buildTarget": "src.main.java.nate.company.java.angular.angularclient:build:production"
            },
            "development": {
              "buildTarget": "src.main.java.nate.company.java.angular.angularclient:build:development"
            }
          },
