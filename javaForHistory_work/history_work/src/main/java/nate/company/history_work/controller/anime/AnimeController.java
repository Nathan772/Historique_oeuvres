...
//            actualUser.removeFromWatchedAnime(watchedToRemoveOpt.get());
...
//
//            //retrieve and update if it already exists
//            var alreadyWatchedMovieOpt =watchedAnimeService.findByUserAndAnime(userOpt.get(),animeAlreadyExistsOpt.get());
//
//            //the movie is already in the data base don't need to recreate with the same imdb
...
//
//                actualUser.addWatchedAnime(alreadyWatchedMovie);
//                animeChosen.addIsWatchedBy(actualUser);
//
//                //makes them persistent in db
//                animeShortService.saveAnimeShort(animeChosen);
//                //this specific order is compulsory
//                watchedAnimeService.saveWatchAnime(alreadyWatchedMovie);
//                userService.saveUser(actualUser);
//
//                // Getting organisation object as a json string
//                String jsonStr;
//                try {
//                    jsonStr = FROMJSONCONVERTER.writeValueAsString(new WatchedAnimeDto(alreadyWatchedMovie));
//                } catch (JsonProcessingException e) {
//                    throw new AssertionError("not proper json format for watch movie :" +e);
//                }
//
...
//
//            var watchedAnime = new WatchedAnime(actualUser,animeAlreadyExistsOpt.get(), VisualArtStatus.fromStringToMovieStatus(nestedMap.get("animeStatus")),
...
//         */
//
//        var watchedAnime = new WatchedAnime(actualUser,anime, VisualArtStatus.fromStringToMovieStatus(nestedMap.get("movieStatus")),
//                fromOnlyTimeToSeconds(onlyTimeOfMovie));
//        System.out.println("l'état de watched movie avant la création du dto : "+watchedAnime);
//
//
