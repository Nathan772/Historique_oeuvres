...
//                alreadyWatchedAnime.setTimeAsLong(fromOnlyTimeToSeconds(onlyTimeOfMovie));
//
//                //update "watched status"
//                alreadyWatchedAnime.setArtStatus(VisualArtStatus.fromStringToMovieStatus(nestedMap.get("movieStatus")));
//
//                actualUser.addWatchedAnime(alreadyWatchedAnime.getAnimeShort());
...
//        var watchedMovies =userOpt.get().getWatchAnime().stream().map(animeShort->new WatchedAnimeDto( animeShort)).toList();
//        try {
