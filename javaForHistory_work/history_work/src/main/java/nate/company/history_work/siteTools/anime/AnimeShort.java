...
//    private long id;
//    @OneToMany(fetch = FetchType.LAZY,mappedBy="animeReacted", cascade = CascadeType.ALL)
...
//   */
//    @ManyToMany(fetch = FetchType.LAZY,mappedBy="actorsAnime", cascade = CascadeType.ALL)
