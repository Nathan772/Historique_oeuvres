...
@Component({
  selector: 'app-navbar-series',
  templateUrl: './navbar-series.component.html',
  styleUrls: ['./navbar-series.component.css'],
})
export class NavbarSeriesComponent implements OnInit {
